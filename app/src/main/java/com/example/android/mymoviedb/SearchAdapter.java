...
public class SearchAdapter extends Adapter<SearchAdapter.ViewHolder> {   // Provide a reference to the views for each data item
    ...
    public SearchAdapter(Context context, List<String> myDataset, List<String> myURLDataset, ArrayList<Integer> movie_id) {
        values = myDataset;
