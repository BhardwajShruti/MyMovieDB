...
public class MyAdapter extends Adapter<MyAdapter.ViewHolder> {   // Provide a reference to the views for each data item
    ...
    public MyAdapter(Context context, List<String> myDataset, List<String> myURLDataset, ArrayList<Integer> movie_id) {
        values = myDataset;
    ...
    public MyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        LayoutInflater inflater = LayoutInflater.from(
                parent.getContext());
        View v =
                inflater.inflate(R.layout.movie_icon, parent, false);
